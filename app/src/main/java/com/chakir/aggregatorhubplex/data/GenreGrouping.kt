...
object GenreGrouping {
    ...
    val GROUPS = mapOf(
        ...
        "Action & Aventure" to listOf("Action", "Adventure", "Aventure", "Martial Arts", "Action/Aventure"),

        "Sci-Fi & Fantastique" to listOf("Sci-Fi", "Science Fiction", "Fantasy", "Sci-Fi &amp; Fantasy"),
        ...
        "Thriller & Horreur" to listOf("Thriller", "Horror", "Suspense", "Crime", "Mystery", "Film-Noir"),

        "Guerre & Histoire" to listOf("War", "History", "Western", "Biography"),

        "Documentaire & TV" to listOf("Documentary", "Reality", "Game Show", "Talk", "News", "Home And Garden", "Food", "Travel", "Sport", "Music", "Musical", "Indie")
    )
