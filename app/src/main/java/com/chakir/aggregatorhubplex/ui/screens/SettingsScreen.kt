...
fun SettingsScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text("Paramètres", style = MaterialTheme.typography.displaySmall, color = Color.White, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(48.dp))

            // Carte Serveur
            SettingsCard(title = "Serveur Actuel", icon = Icons.Default.Dns) {
                Text(serverUrl ?: "Non connecté", style = MaterialTheme.typography.headlineSmall, color = PlexAccent, fontWeight = FontWeight.Bold)
            }
...
fun SettingsCard(title: String, icon: androidx.compose.ui.graphics.vector.ImageVector, content: @Composable () -> Unit) {
    Column(modifier = Modifier.fillMaxWidth().background(Color(0xFF1F1F1F), RoundedCornerShape(12.dp)).padding(16.dp)) {
